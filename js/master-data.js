const clientData = {
    owner: [
        {
            nickname: 'Muis',
            fullname: 'Abdul Muis Alfatah',
            desc: 'Putri dari Bapak Kamsuri & Ibu Siswati',
            imgProfile: 'https://drive.google.com/file/d/1U4s7bhpdXjk3qT2GItIoJGgoB7keROwo/view?usp=sharing',
            address: 'Kebonagung RT 01 RW 01 Kec. tegowanu Kab. Grobogan'
        },
        {
            nickname: 'Risa',
    ...
    event: [
        {
            title: 'Akad Nikah',
            startDateTime: '2022-05-08 08:30:00',
            timeText: '08.30 WIB - selesai',
            location: 'Kediaman Mempelai Wanita',
            address: 'Ds. Plosorejo RT01/RW02, Kec. Pucakwangi, Kab. Pati',
            maps: ''
        },
        {
            title: 'Resepsi',
    ...
    stream: [
        { code: 'ig', link: 'https://www.youtube.com/watch?v=r00ikilDxW4&list=RDk36efi9StIY&index=21' },
        { code: 'yt', link: 'https://www.youtube.com/watch?v=r00ikilDxW4&list=RDk36efi9StIY&index=21' },
